...
(function () {
	...
	angular.module('orange', ['ui.router', 'orange.config', 'orange.factories', 'orange.services', 'orange.controllers']);
})();
(function() {
    'use strict';
...
(function() {
    'use strict';
    angular.module('orange.factories', []);
})();
...
angular.module("orange.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("/app/chat.html","<ul id=messages></ul><div id=typing></div><form action=\"\"><input id=m autocomplete=off> <button>Send</button></form>");
$templateCache.put("/app/games/index.html","");}]);