...
!function(){"use strict";function e(e,r,t,o){t.baseUrl=o.baseUrl,t.loginUrl="/auth",e.state("app",{url:"","abstract":!0,template:'<div id="base" ui-view></div>',controller:"BaseCtrl as Base"}).state("app.master",{url:"",templateUrl:"/cache/layouts/master.html","abstract":!0}).state("app.simple",{url:"",templateUrl:"/cache/layouts/simple.html","abstract":!0}).state("app.master.chat",{url:"/chat",title:"Chat",controller:"ChatCtrl as Base",templateUrl:"/cache/chat.html"}).state("app.master.profile",{url:"/profile",title:"Profile",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/index.html"}).state("app.master.profile-edit",{url:"/profile/edit",title:"Profile | Edit",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/edit.html"}).state("app.simple.register",{url:"/register",title:"Register",controller:"RegisterCtrl as Register",templateUrl:"/cache/sessions/register.html"}),r.otherwise("/profile")}angular.module("orange.config",["orange.constants"]).config(e),e.$inject=["$stateProvider","$urlRouterProvider","$authProvider","Config"]}(),function(){"use strict";angular.module("orange.constants",[]).constant("Config",{baseUrl:"http://localhost:4200/",siteName:"Orange Gaming"})}(),function(){"use strict";angular.module("orange",["btford.socket-io","ngAnimate","satellizer","http-auth-interceptor","ui.router","orange.templates","orange.config","orange.factories","orange.services","orange.controllers","orange.run"])}(),function(){"use strict";function e(e,r,t){$(document).ready(function(){$(".dropdown-button").dropdown()}),e.$on("$stateChangeSuccess",function(){e.title=r.current.title,t.clear()})}angular.module("orange.run",[]).run(e),e.$inject=["$rootScope","$state","ErrorsFactory"]}(),function(){"use strict";function e(e,r,t,o,n,a,s){function i(){r.session=n.session.session,r.config=a,r.errorCollection=s.errorCollection,u.data={forms:{login:{username:"",password:""}}},console.log("Loading base controller"),n.profile()}function c(){$(function(){"app.simple.register"!=t.current.name&&$("#login").openModal()})}function l(){$(function(){$("#login").closeModal()})}var u=this;i(),e.$on("event:auth-loginRequired",function(e,r){n.logout(),c()}),e.$on("event:auth-loginConfirmed",function(e,r){l()}),r.register=function(){l(),t.go("app.simple.register")},r.login=function(){n.login(u.data.forms.login).then(function(e){u.data.forms.login={},o.loginConfirmed(),l()},function(e){console.log(e)})},r.logout=function(){e.$broadcast("event:auth-loginRequired")}}angular.module("orange.controller.base",[]).controller("BaseCtrl",e),e.$inject=["$rootScope","$scope","$state","authService","SessionsFactory","Config","ErrorsFactory"]}(),function(){"use strict";function e(e,r){function t(){console.log("Loading the chat controller")}t();var o,n=1e3;$("#m");$(document).ready(function(){function e(){r.emit("chat:typing-stopped")}$(document).keypress(function(r){13==r.which&&e()}),$("form").submit(function(){return r.emit("chat:message",$("#m").val()),$("#m").val(""),!1}),r.on("chat:message",function(e){$("#messages").append($("<li>").text(e))}),r.on("chat:typing",function(){$("#typing").text("A user is typing")}),r.on("chat:typing-stopped",function(){$("#typing").text("")}),$("#m").keyup(function(){clearTimeout(o),r.emit("chat:typing"),o=setTimeout(e,n)}),$("#m").keydown(function(){r.emit("chat:typing"),clearTimeout(o)})})}angular.module("orange.controller.chat",[]).controller("ChatCtrl",e),e.$inject=["$scope","SocketFactory"]}(),function(){"use strict";angular.module("orange.controllers",["orange.controller.base","orange.controller.chat","orange.controller.profile","orange.controller.register"])}(),function(){"use strict";function e(e,r,t){function o(){console.log("loaded the profile controller"),n.data={forms:{edit:{}}}}var n=this;o(),n.update=function(){t.update(e.session.current_user).then(function(){r.go("app.master.profile")},function(){})}}angular.module("orange.controller.profile",[]).controller("ProfileCtrl",e),e.$inject=["$scope","$state","UsersFactory"]}(),function(){"use strict";function e(e,r,t){function o(){n.data={forms:{register:{}}}}var n=this;o(),n.register=function(){t.register(n.data.forms.register).then(function(){n.data.forms.register={},r.go("app.master.profile")},function(){})}}angular.module("orange.controller.register",[]).controller("RegisterCtrl",e),e.$inject=["$scope","$state","SessionsFactory"]}(),function(){"use strict";function e(e){function r(r){o.errors=e.format(r),console.log(o.errors)}function t(){o.errors=null}var o={errors:null},n={errorCollection:o,registration:r,clear:t};return n}angular.module("orange.factory.errors",[]).factory("ErrorsFactory",e),e.$inject=["FormErrorsService"]}(),function(){"use strict";angular.module("orange.factories",["orange.factory.socket","orange.factory.sessions","orange.factory.errors","orange.factory.users"])}(),function(){"use strict";function e(e,r,t,o,n,a,s,i,c){function l(e){i.create(p,e)}function u(e){var r=o.defer(),t={ignoreAuthModule:!0};return n.login(e,t).then(function(e){i.create(p,e.data.user),r.resolve()})["catch"](function(e){r.reject(e)}),r.promise}function f(){n.logout(),i.destroy(p)}function g(){var n=localStorage.getItem("current_user"),s=o.defer();return"null"===n||null===n||void 0===n||"undefined"===n?(r(function(){t.$broadcast("event:auth-loginRequired")},1),s.reject()):(n=JSON.parse(n),e.get(a.baseUrl+"api/users/"+n.id).success(function(e){i.create(p,e.data),s.resolve()}).error(function(e){s.reject(e)})),s.promise}function m(r){var t=o.defer();return e({method:"POST",url:a.baseUrl+"sessions/sign-up",data:r}).success(function(e){i.create(p,e.user,e.token),t.resolve()}).error(function(e){c.registration(e),t.reject()}),t.promise}var p={session:{current_user:null,logged_in:!1}},d={login:u,logout:f,profile:g,register:m,session:p,create:l};return d}angular.module("orange.factory.sessions",[]).factory("SessionsFactory",e),e.$inject=["$http","$timeout","$rootScope","$q","$auth","Config","JWTService","SessionsService","ErrorsFactory"]}(),function(){"use strict";function e(e){var r=io.connect("http://localhost:4200"),t=e({ioSocket:r});return t}angular.module("orange.factory.socket",[]).factory("SocketFactory",e),e.$inject=["socketFactory"]}(),function(){"use strict";function e(e,r,t,o){function n(n){var a=r.defer();return e({method:"PUT",url:t.baseUrl+"api/users/"+n.id,data:n}).success(function(e){o.create(e.data),a.resolve()}).error(function(e){console.log(e),a.reject()}),a.promise}var a={update:n};return a}angular.module("orange.factory.users",[]).factory("UsersFactory",e),e.$inject=["$http","$q","Config","SessionsFactory"]}(),function(){"use strict";function e(){function e(e,r){var t=0;for(t;t<r.length;t++)return r[t]===e?!0:!1}var r=this;r.format=function(r){var t={};if(r.length&&r[0].hasOwnProperty("param")&&r[0].hasOwnProperty("msg")){var o=0;for(o;o<r.length;o++){var n=t[r[o].param];if(n)e(r[o].msg,n)||t[r[o].param].push(r[o].msg);else{var a=r[o].param;"name.first"==a?a="first_name":"name.last"==a&&(a="last_name"),t[a]=[r[o].msg]}}}return t}}angular.module("orange.service.form_errors",[]).service("FormErrorsService",e),e.$inject=[]}(),function(){"use strict";function e(e){var r=this;r.parse=function(r){var t=r.split(".")[1],o=t.replace("-","+").replace("_","/");return JSON.parse(e.atob(o))},r.save=function(r){e.localStorage._satellizer_token=r},r.get=function(){return e.localStorage.satellizer_token}}angular.module("orange.service.jwt",[]).service("JWTService",e),e.$inject=["$window"]}(),function(){"use strict";angular.module("orange.services",["orange.service.jwt","orange.service.sessions","orange.service.form_errors"])}(),function(){"use strict";function e(e){var r=this;r.create=function(r,t,o){console.log(t),e.localStorage.current_user=JSON.stringify(t),o&&""!==o&&null!==o&&"null"!==o&&($http.defaults.headers.common.Authorization="Bearer "+res.token,e.localStorage.satellizer_token=o,e.localStorage._satellizer_token=o),r.session.current_user=t,r.session.logged_in=!0},r.destroy=function(r){e.localStorage.removeItem("_satellizer_token"),e.localStorage.removeItem("satellizer_token"),e.localStorage.removeItem("current_user"),r.session.current_user={},r.session.logged_in=!1}}angular.module("orange.service.sessions",[]).service("SessionsService",e),e.$inject=["$window"]}();
