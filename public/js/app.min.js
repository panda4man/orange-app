...
!function(){"use strict";function t(t,e,o,r){o.baseUrl=r.baseUrl,o.loginUrl="/auth",t.state("app",{url:"","abstract":!0,template:"<div ui-view></div>",controller:"BaseCtrl as Base"}).state("app.master",{url:"",templateUrl:"/cache/layouts/master.html","abstract":!0}).state("app.simple",{url:"",templateUrl:"/cache/layouts/simple.html","abstract":!0}).state("app.master.chat",{url:"/chat",title:"Chat",controller:"ChatCtrl as Base",templateUrl:"/cache/chat.html"}).state("app.master.profile",{url:"/profile",title:"Profile",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/index.html"}).state("app.master.profile-edit",{url:"/profile/edit",title:"Profile | Edit",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/edit.html"}).state("app.simple.register",{url:"/register",title:"Register",controller:"RegisterCtrl as Register",templateUrl:"/cache/sessions/register.html"}),e.otherwise("/profile")}angular.module("orange.config",["orange.constants"]).config(t),t.$inject=["$stateProvider","$urlRouterProvider","$authProvider","Config"]}(),function(){"use strict";angular.module("orange.constants",[]).constant("Config",{baseUrl:"http://localhost:4200/",siteName:"Orange Gaming"})}(),function(){"use strict";angular.module("orange",["btford.socket-io","satellizer","http-auth-interceptor","ui.router","orange.templates","orange.config","orange.factories","orange.services","orange.controllers","orange.run"])}(),function(){"use strict";function t(t,e){$(document).ready(function(){$(".dropdown-button").dropdown()}),t.$on("$stateChangeSuccess",function(){t.title=e.current.title})}angular.module("orange.run",[]).run(t),t.$inject=["$rootScope","$state"]}(),function(){"use strict";function t(t,e,o,r,n,a){function i(){e.session=n.session,e.config=a,s.data={forms:{login:{username:"",password:""}}},console.log("Loading base controller"),n.profile()}function l(){$(function(){$("#login").openModal()})}function c(){$(function(){$("#login").closeModal()})}var s=this;i(),t.$on("event:auth-loginRequired",function(t,e){n.logout(),l()}),t.$on("event:auth-loginConfirmed",function(t,e){c()}),e.register=function(){c(),o.go("app.simple.register")},e.login=function(){n.login(s.data.forms.login).then(function(t){s.data.forms.login={},r.loginConfirmed(),c()},function(t){console.log(t)})},e.logout=function(){t.$broadcast("event:auth-loginRequired")}}angular.module("orange.controller.base",[]).controller("BaseCtrl",t),t.$inject=["$rootScope","$scope","$state","authService","SessionsFactory","Config"]}(),function(){"use strict";function t(t,e){function o(){console.log("Loading the chat controller")}o();var r,n=1e3;$("#m");$(document).ready(function(){function t(){e.emit("chat:typing-stopped")}$(document).keypress(function(e){13==e.which&&t()}),$("form").submit(function(){return e.emit("chat:message",$("#m").val()),$("#m").val(""),!1}),e.on("chat:message",function(t){$("#messages").append($("<li>").text(t))}),e.on("chat:typing",function(){$("#typing").text("A user is typing")}),e.on("chat:typing-stopped",function(){$("#typing").text("")}),$("#m").keyup(function(){clearTimeout(r),e.emit("chat:typing"),r=setTimeout(t,n)}),$("#m").keydown(function(){e.emit("chat:typing"),clearTimeout(r)})})}angular.module("orange.controller.chat",[]).controller("ChatCtrl",t),t.$inject=["$scope","SocketFactory"]}(),function(){"use strict";angular.module("orange.controllers",["orange.controller.base","orange.controller.chat","orange.controller.profile","orange.controller.register"])}(),function(){"use strict";function t(t){function e(){console.log("loaded the profile controller"),o.data={}}var o=this;e()}angular.module("orange.controller.profile",[]).controller("ProfileCtrl",t),t.$inject=["$scope"]}(),function(){"use strict";function t(t){function e(){o.data={}}var o=this;e()}angular.module("orange.controller.register",[]).controller("RegisterCtrl",t),t.$inject=["$scope"]}(),function(){"use strict";angular.module("orange.factories",["orange.factory.socket","orange.factory.sessions"])}(),function(){"use strict";function t(t,e,o,r,n,a){function i(t){var e=r.defer(),o={ignoreAuthModule:!0};return n.login(t,o).then(function(t){localStorage.setItem("current_user",JSON.stringify(t.data.user)),s.current_user=t.data.user,s.logged_in=!0,e.resolve()})["catch"](function(t){e.reject(t)}),e.promise}function l(){n.logout(),s.logged_in=!1,s.current_user={},localStorage.setItem("current_user",null)}function c(){var n=localStorage.getItem("current_user"),i=r.defer();return"null"===n||null===n||void 0===n||"undefined"===n?(e(function(){o.$broadcast("event:auth-loginRequired")},1),i.reject()):(n=JSON.parse(n),t.get(a.baseUrl+"api/users/"+n.id).success(function(t){localStorage.setItem("current_user",JSON.stringify(t.data)),s.current_user=t.data,s.logged_in=!0,i.resolve()}).error(function(t){i.reject(t)})),i.promise}var s={},u={login:i,logout:l,profile:c,session:s};return u}angular.module("orange.factory.sessions",[]).factory("SessionsFactory",t),t.$inject=["$http","$timeout","$rootScope","$q","$auth","Config"]}(),function(){"use strict";function t(t){var e=io.connect("http://localhost:4200"),o=t({ioSocket:e});return o}angular.module("orange.factory.socket",[]).factory("SocketFactory",t),t.$inject=["socketFactory"]}(),function(){"use strict";angular.module("orange.services",[])}();
