...
!function(){"use strict";function e(e,r,t,o){t.baseUrl=o.baseUrl,t.loginUrl="/auth",e.state("app",{url:"","abstract":!0,template:'<div id="base" ui-view></div>',controller:"BaseCtrl as Base"}).state("app.master",{url:"",templateUrl:"/cache/layouts/master.html","abstract":!0}).state("app.simple",{url:"",templateUrl:"/cache/layouts/simple.html","abstract":!0}).state("app.master.hangman",{url:"/hangman","abstract":!0,controller:"HangmanCtrl as Hangman",template:"<div ui-view></div>"}).state("app.master.hangman.index",{url:"/",title:"Hangman",controller:"HangmanIndexCtrl as Hangman",templateUrl:"/cache/games/hangman/index.html"}).state("app.master.hangman.create",{url:"/create",title:"Hangman | create",controller:"HangmanCreateCtrl as Hangman",templateUrl:"/cache/games/hangman/create.html"}).state("app.master.hangman.lobby",{url:"/:room/lobby",title:"Hangman | Lobby",controller:"HangmanLobbyCtrl as Hangman",templateUrl:"/cache/games/hangman/lobby.html"}).state("app.master.profile",{url:"/profile",title:"Profile",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/index.html"}).state("app.master.profile-edit",{url:"/profile/edit",title:"Profile | Edit",controller:"ProfileCtrl as Profile",templateUrl:"/cache/profile/edit.html"}).state("app.simple.register",{url:"/register",title:"Register",controller:"RegisterCtrl as Register",templateUrl:"/cache/sessions/register.html"}),r.otherwise("/profile")}angular.module("orange.config",["orange.constants"]).config(e),e.$inject=["$stateProvider","$urlRouterProvider","$authProvider","Config"]}(),function(){"use strict";angular.module("orange.constants",[]).constant("Config",{baseUrl:"http://localhost:4200/",siteName:"Orange Gaming"})}(),function(){"use strict";angular.module("orange",["btford.socket-io","ngAnimate","satellizer","http-auth-interceptor","ui.router","orange.templates","orange.config","orange.factories","orange.services","orange.controllers","orange.run"])}(),function(){"use strict";function e(e,r,t){$(document).ready(function(){$(".dropdown-button").dropdown()}),e.$on("$stateChangeSuccess",function(){e.title=r.current.title,t.clear()})}angular.module("orange.run",[]).run(e),e.$inject=["$rootScope","$state","ErrorsFactory"]}(),function(){"use strict";function e(e){function r(r){o.errors=e.format(r),console.log(o.errors)}function t(){o.errors=null}var o={errors:null},n={errorCollection:o,registration:r,clear:t};return n}angular.module("orange.factory.errors",[]).factory("ErrorsFactory",e),e.$inject=["FormErrorsService"]}(),function(){"use strict";function e(e,r,t){function o(){var o=r.defer();return e.get(t.baseUrl+"api/games/hangman").success(function(e){o.resolve(e.data)}).error(function(e){console.log(e),o.reject()}),o.promise}var n={all:o};return n}angular.module("orange.factory.games.hangman",[]).factory("HangmanFactory",e),e.$inject=["$http","$q","Config"]}(),function(){"use strict";angular.module("orange.factories",["orange.factory.socket","orange.factory.sessions","orange.factory.errors","orange.factory.users","orange.factory.games.hangman"])}(),function(){"use strict";function e(e,r,t,o,n,a,s,c,i){function l(e){c.create(d,e)}function u(e){var r=o.defer(),t={ignoreAuthModule:!0};return n.login(e,t).then(function(e){c.create(d,e.data.user),r.resolve()})["catch"](function(e){r.reject(e)}),r.promise}function g(){n.logout(),c.destroy(d)}function f(){var n=localStorage.getItem("current_user"),s=o.defer();return"null"===n||null===n||void 0===n||"undefined"===n?(r(function(){t.$broadcast("event:auth-loginRequired")},1),s.reject()):(n=JSON.parse(n),e.get(a.baseUrl+"api/users/"+n.id).success(function(e){c.create(d,e.data),s.resolve()}).error(function(e){s.reject(e)})),s.promise}function m(r){var t=o.defer();return e({method:"POST",url:a.baseUrl+"sessions/sign-up",data:r}).success(function(e){c.create(d,e.user,e.token),t.resolve()}).error(function(e){i.registration(e),t.reject()}),t.promise}var d={session:{current_user:null,logged_in:!1}},p={login:u,logout:g,profile:f,register:m,session:d,create:l};return p}angular.module("orange.factory.sessions",[]).factory("SessionsFactory",e),e.$inject=["$http","$timeout","$rootScope","$q","$auth","Config","JWTService","SessionsService","ErrorsFactory"]}(),function(){"use strict";function e(e){function r(){return e.create("hangman")}function t(){return e.create("blackjack")}var o={hangman:r,blackjack:t};return o}angular.module("orange.factory.socket",[]).factory("SocketFactory",e),e.$inject=["SocketService"]}(),function(){"use strict";function e(e,r,t,o){function n(n){var a=r.defer();return e({method:"PUT",url:t.baseUrl+"api/users/"+n.id,data:n}).success(function(e){o.create(e.data),a.resolve()}).error(function(e){console.log(e),a.reject()}),a.promise}var a={update:n};return a}angular.module("orange.factory.users",[]).factory("UsersFactory",e),e.$inject=["$http","$q","Config","SessionsFactory"]}(),function(){"use strict";function e(e,r,t,o,n,a,s){function c(){r.session=n.session.session,r.config=a,r.errorCollection=s.errorCollection,u.data={forms:{login:{username:"",password:""}}},console.log("Loading base controller"),n.profile()}function i(){$(function(){"app.simple.register"!=t.current.name&&$("#login").openModal()})}function l(){$(function(){$("#login").closeModal()})}var u=this;c(),e.$on("event:auth-loginRequired",function(e,r){n.logout(),i()}),e.$on("event:auth-loginConfirmed",function(e,r){l()}),r.register=function(){l(),t.go("app.simple.register")},r.login=function(){n.login(u.data.forms.login).then(function(e){u.data.forms.login={},o.loginConfirmed(),l()},function(e){console.log(e)})},r.logout=function(){e.$broadcast("event:auth-loginRequired")}}angular.module("orange.controller.base",[]).controller("BaseCtrl",e),e.$inject=["$rootScope","$scope","$state","authService","SessionsFactory","Config","ErrorsFactory"]}(),function(){"use strict";function e(e,r,t,o){function n(){console.log("Loading the chat controller"),e.socket=o.hangman(),e.socket.on("game:error",function(e){console.log(e)}),e.socket.on("game:joined",function(e){console.log("Someone joined: "+JSON.stringify(e))}),e.socket.on("game:left",function(e){console.log("Someone left "+JSON.stringify(e))})}n()}angular.module("orange.controller.hangman.base",[]).controller("HangmanCtrl",e),e.$inject=["$scope","$state","$timeout","SocketFactory"]}(),function(){"use strict";angular.module("orange.controllers",["orange.controller.base","orange.controller.hangman.base","orange.controllers.hangman","orange.controller.profile","orange.controller.register"])}(),function(){"use strict";function e(e,r,t){function o(){console.log("loaded the profile controller"),n.data={forms:{edit:{}}}}var n=this;o(),n.update=function(){t.update(e.session.current_user).then(function(){r.go("app.master.profile")},function(){})}}angular.module("orange.controller.profile",[]).controller("ProfileCtrl",e),e.$inject=["$scope","$state","UsersFactory"]}(),function(){"use strict";function e(e,r,t){function o(){n.data={forms:{register:{}}}}var n=this;o(),n.register=function(){t.register(n.data.forms.register).then(function(){n.data.forms.register={},r.go("app.master.profile")},function(){})}}angular.module("orange.controller.register",[]).controller("RegisterCtrl",e),e.$inject=["$scope","$state","SessionsFactory"]}(),function(){"use strict";function e(){function e(e,r){var t=0;for(t;t<r.length;t++)return r[t]===e?!0:!1}var r=this;r.format=function(r){var t={};if(r.length&&r[0].hasOwnProperty("param")&&r[0].hasOwnProperty("msg")){var o=0;for(o;o<r.length;o++){var n=t[r[o].param];if(n)e(r[o].msg,n)||t[r[o].param].push(r[o].msg);else{var a=r[o].param;"name.first"==a?a="first_name":"name.last"==a&&(a="last_name"),t[a]=[r[o].msg]}}}return t}}angular.module("orange.service.form_errors",[]).service("FormErrorsService",e),e.$inject=[]}(),function(){"use strict";function e(e){var r=this;r.parse=function(r){var t=r.split(".")[1],o=t.replace("-","+").replace("_","/");return JSON.parse(e.atob(o))},r.save=function(r){e.localStorage._satellizer_token=r},r.get=function(){return e.localStorage.satellizer_token}}angular.module("orange.service.jwt",[]).service("JWTService",e),e.$inject=["$window"]}(),function(){"use strict";angular.module("orange.services",["orange.service.jwt","orange.service.sessions","orange.service.form_errors","orange.service.socket"])}(),function(){"use strict";function e(e){var r=this;r.create=function(r,t,o){console.log(t),e.localStorage.current_user=JSON.stringify(t),o&&""!==o&&null!==o&&"null"!==o&&($http.defaults.headers.common.Authorization="Bearer "+res.token,e.localStorage.satellizer_token=o,e.localStorage._satellizer_token=o),r.session.current_user=t,r.session.logged_in=!0},r.destroy=function(r){e.localStorage.removeItem("_satellizer_token"),e.localStorage.removeItem("satellizer_token"),e.localStorage.removeItem("current_user"),r.session.current_user={},r.session.logged_in=!1}}angular.module("orange.service.sessions",[]).service("SessionsService",e),e.$inject=["$window"]}(),function(){"use strict";function e(e){this.create=function(r){var t=io.connect("http://localhost:4200/"+r);return e({ioSocket:t})}}angular.module("orange.service.socket",[]).service("SocketService",e),e.$inject=["socketFactory"]}(),function(){"use strict";function e(e,r,t){function o(){n.data={forms:{create:{status:"created",players:[]}}},t(function(){n.data.forms.create.owner=e.session.current_user.id},500)}var n=this;o(),e.socket.on("game:created",function(e){console.log(e),r.go("app.master.hangman.lobby",{room:e.room})}),n.create=function(){e.socket.emit("create",n.data.forms.create)}}angular.module("orange.controller.hangman.create",[]).controller("HangmanCreateCtrl",e),e.$inject=["$scope","$state","$timeout"]}(),function(){"use strict";function e(e){function r(){t.data={}}var t=this;r()}angular.module("orange.controller.hangman.game",[]).controller("HangmanGameCtrl",e),e.$inject=["$scope"]}(),function(){"use strict";function e(e,r){function t(){n.data={games:[]},o()}function o(){console.log("Retrieving updated game list."),r.all().then(function(e){n.data.games=e},function(){})}var n=this;t(),e.socket.on("game:leave",function(e){o()}),e.socket.on("game:ended",function(){console.log("Game just closed"),o()})}angular.module("orange.controller.hangman.index",[]).controller("HangmanIndexCtrl",e),e.$inject=["$scope","HangmanFactory"]}(),function(){"use strict";function e(e,r){function t(){console.log("Loading the hangman lobby controller"),o.data={game:null},e.socket.emit("join",e.session.current_user,r.room)}var o=this;t(),o.ready=function(){},o.notReady=function(){},e.socket.on("game:joined",function(e){console.log("%s just joined the game!",e.player.full_name),o.data.game=e.game}),e.socket.on("game:leave",function(e){console.log("%s just left the game!",e.player.full_name),o.data.game=e.game}),e.$on("$destroy",function(){console.log("%s is leaving the lobby",e.session.current_user.id),e.socket.emit("leave",e.session.current_user,r.room)})}angular.module("orange.controller.hangman.lobby",[]).controller("HangmanLobbyCtrl",e),e.$inject=["$scope","$stateParams"]}(),function(){"use strict";angular.module("orange.controllers.hangman",["orange.controller.hangman.index","orange.controller.hangman.create","orange.controller.hangman.lobby"])}();
